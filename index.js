...
/* if u use replit use this code 
and  go to shell and type :

npm install express

app.listen(3000, () => console.log("I'm Ready To Work..! 24H"));
app.get('/', (req, res) => {
  res.send(`
  <body>
...
/* if u dont use replit create file and name it .env and type :
